...
import (
	...
	"github.com/yndd/nddr-as-registry/internal/controllers"
	"github.com/yndd/nddr-as-registry/internal/grpcserver"
...
var startCmd = &cobra.Command{
	Use:          "start",
	Short:        "start the as-registry manager",
	Long:         "start the as-registry manager",
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		nddcopts := &shared.NddControllerOptions{
			Logger:    logging.NewLogrLogger(zlog.WithName("as-registry")),
			Poll:      pollInterval,
			Namespace: namespace,
			Handler:   handler,
		}

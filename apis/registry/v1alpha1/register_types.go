...
// NddrAsRegister struct
type NddrAsRegister struct {
	AsRegister `json:",inline"`
...
// AspoolRegister struct
type AsRegister struct {
...
type RegisterSpec struct {
	Register *NddrAsRegister `json:"register,omitempty"`
}
...
// +kubebuilder:printcolumn:name="AS",type="string",JSONPath=".status.register.state.as",description="assigned NI index"
